...
#### 3.2.3 Message Body
   - Type: `Binary`  
   - Description: This field contains the user's business data.  
...
#### 3.3.5 BornHost
   - Type: `String` 
   - Description: The host that generated this message. When a message is sent, this field will be set with the local host info of server.
   - Constraints: REQUIRED and MUST be a non-empty string.
